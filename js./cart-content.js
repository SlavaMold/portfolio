            ...
            if (cart == null) {
                ...
                for (var key in cart) {
                    ...
                    if (data[cart[key]].Msq == 'NO') {
                        ...
                        out += '<button class="delete" data-art="' + key + '"><img class="delete_img" src="../img/trash.png"></button>';
                        out += '<img class="product-img" src="' + data[cart[key]]['image'] + '">';
                        out += '<div class="product-txt1"> <div class="product-descr">' + data[cart[key]]['name'] + ' <br><span class="price-about"> <i name="cost">' + data[cart[key]]['cost'] + '</i> MDL' + ' <br><br>' + data[cart[key]]['description'] + ' </span></div>';
                        out += '</div>';
                        out += '</div>';
                    }
