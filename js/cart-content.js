                ...
                for (var key in cart) {
                    if (data[cart[key]].Msq == 'YES') {
                        ...
                        if(data[cart[key]].Special == 'YES'){
                            out += '<div class="product-txt1"> <div class="product-descr">' + data[cart[key]]['name'] + ' <br><span class="price-about">От <i name="cost">' + data[cart[key]]['cost'] + '</i> MDL/M<sup>2</sup>' + ' <br>' + data[cart[key]]['description'] + '</span></div>';
                        }
                        else{
                    ...
                    if (data[cart[key]].Msq == 'NO') {
                        ...
                        out += '<img class="product-img" src="' + data[cart[key]]['image'] + '">';
                        if(data[cart[key]].Special == 'YES'){
                            out += '<div class="product-txt1"> <div class="product-descr">' + data[cart[key]]['name'] + ' <br><span class="price-about"> <span>От <i name="cost">' + data[cart[key]]['cost'] + '</i> </span> MDL' + ' <br><br>' + data[cart[key]]['description'] + ' </span></div>';
                        }
                        else{
