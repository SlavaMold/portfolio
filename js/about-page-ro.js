        ...
        for (let key in data) {
            if (data[key]['Special'] == 'NO') {
                if (data[key]['Msq'] == 'NO') {
                    ...
                    <div class="button-add"><button class="add-to-cart" data='`+ key +`'>Adaugă în coș</button>
                    <div class="accord-button"><button class="accord-butt" id="`+ key +`">Informație</button></div>
                    </div>
                    </div>
                    </div>
                ...
                <div class="product-txt1">
                <div class="product-descr">
                `+ data[key]['name'] + `<span class="price-about"><i id="ext">începand de la </i><b>80</b> MDL</span>
    ...
    function mainFunc() {
        ...
        if (sal == true) {
            ...
            blocks.forEach(el => {
                ...
                newHtml += '<div class="col-2"><img class="sale" src="../img/other/sale.png"><span> Reducere valabilă până la data de </span>';
                newHtml += `
                <table class="timeTo">
